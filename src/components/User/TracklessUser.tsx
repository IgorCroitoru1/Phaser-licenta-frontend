...
// import { VideoTrack, TrackReferenceOrPlaceholder, useIsSpeaking, useEnsureTrackRef, AudioTrack, ParticipantTile, useMaybeTrackRefContext, useIsMuted, useEnsureParticipant, useTrackRefContext, useMaybeParticipantContext } from '@livekit/components-react';
...
// interface TracklessUserProps {
//   // trackRef: TrackReferenceOrPlaceholder | null;
//   user: ChannelUser;
//   participant?: Participant; // Replace with the correct type for participant
// }

// const TracklessUser = forwardRef<HTMLDivElement, TracklessUserProps>(({ user, participant: prt }, externalRef) => {
...
//       <div className={`relative w-full h-full rounded-2xl overflow-hidden ${isSpeaking ? 'ring-4 ring-green-400' : ''}`}>
//         {isVideoActive ? (
//           <VideoTrack
//             trackRef={trackRef}
...
//         title={user.name}
//       >
//         <div className="flex items-center w-full gap-1 whitespace-nowrap">
//           <div className = "overflow-hidden  text-ellipsis text-center">
//           {user.name}
//           </div>
//             {isMicroMuted && (
//             <Icons.micOff className='bg-red-500 rounded-full'/>
//             )}
//         </div>
